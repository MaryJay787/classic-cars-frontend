    ...
    render (){
        ...
        <container>
         <div class="ui secondary pointing menu">
          ...
          <a class="item">View My Car Colliections </a>
          <a class="item">Add Cars </a>
        ...
        <div class="ui card">
        <div class="image">
          <img src="https://secureservercdn.net/184.168.47.225/b8a.cee.myftpupload.com/wp-content/uploads/2013/09/Screen-Shot-2013-09-19-at-4.59.44-PM.png"/>
        </div>
        <div class="content">
